...
function Pricing() {
  ...
  return (
    <section id="pricing" className="md:ml-20 md:mr-20 py-20 bg-gray-50">
      <div className="container mx-auto px-6">
        ...
        <p className="text-center text-gray-600 max-w-3xl mx-auto mb-12">
          Unlock the ability to add unlimited tasks to your roadmap while
          joining vibrant study groups for collaboration, support, and
          motivation.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <div
                className={`pricing-card-header bg-gradient-to-r ${plan.color} text-white p-6 -mx-8 -mt-8 rounded-t-2xl mb-8`}
              >
